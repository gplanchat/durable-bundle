...
final class TemporalReceiversPass implements CompilerPassInterface
{
    ...
    private const FORMER = [
        'durable_temporal_journal' => 'durable_workflows',
        'durable_temporal_activity' => 'durable_activities',
        'durable_temporal_nexus' => 'durable_nexus',
    ];
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        foreach (self::FORMER as $former => $current) {
